...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content mt-1">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" navigation-header"><span>Advertising</span>
            </li>
            <li class=" nav-item"><a href="/campaign"><i class="fa fa-bullhorn"></i><span class="menu-title" data-i18n="Email">Campaigns</span></a>
            </li>
            <li class=" nav-item"><a href="/ad"><i class="feather icon-airplay"></i><span class="menu-title" data-i18n="Chat">Ads</span></a>
            </li>
            <li class=" nav-item"><a href="/creative"><i class="fa fa-lightbulb-o"></i><span class="menu-title" data-i18n="Chat">Creatives</span></a>
            </li>
            <li class=" nav-item"><a href="/audience"><i class="feather icon-users"></i><span class="menu-title" data-i18n="Chat">Audiences</span></a>
            </li>
            <li class=" nav-item"><a href="/tracking"><i class="fa fa-map-pin"></i><span class="menu-title" data-i18n="Chat">Tracking</span></a>
            </li>

            <li class=" navigation-header"><span>Inventory</span>
            </li>
            <li class=" nav-item"><a href="/inventory"><i class="fa fa-cubes"></i><span class="menu-title" data-i18n="Email">Inventory</span></a>
            </li>
            ...
            <li class=" nav-item"><a href="<?=MYACCOUNT_URL?>/billing/deposit"><i class="fa fa-money"></i><span class="menu-title" data-i18n="Google Maps">Deposit</span></a></li>
