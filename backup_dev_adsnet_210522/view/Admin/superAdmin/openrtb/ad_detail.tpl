    ...
    <div class="content-body">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <a class="btn btn-success mb-1" href="/openrtb/report?start_date=<?=$this->data->today?>&end_date=<?=$this->data->today?>&ad_id=<?=$this->data->id?>&country=&group_by=Date&order_by=Date">
                    <span class="icon">
                ...
                <a class="btn btn-primary mb-1" href="/openrtb/report?start_date=<?=$this->data->last7days?>&end_date=<?=$this->data->today?>&ad_id=<?=$this->data->id?>&country=&group_by=Date&order_by=Date">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor" d="M3,22V8H7V22H3M10,22V2H14V22H10M17,22V14H21V22H17Z" />
                        </svg>
                ...
                <a class="btn btn-info mb-1" href="/openrtb/report?start_date=<?=$this->data->last30days?>&end_date=<?=$this->data->today?>&ad_id=<?=$this->data->id?>&country=&group_by=Date&order_by=Date">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor" d="M3,22V8H7V22H3M10,22V2H14V22H10M17,22V14H21V22H17Z" />
                        </svg>
                        ...
                        <div class="card-body card-dashboard">
                                ...
                                <div class="media-content">
                                    ...
                                    <div class="buttons are-transparent">
                                        <a class="btn btn-default"
                                            href="/openrtb/network?id=<?=$this->data->network_id?>">
                                            <span class="icon">
                                                <svg viewBox="0 0 24 24">
                                                    <path fill="currentColor"
                                        ...
                                        <a id="ad-url" class="btn btn-default" href="<?=$this->data->url?>"
                                            target="_blank">
                                            <span class="icon">
                                                <svg viewBox="0 0 24 24">
                                                    <path fill="currentColor"
                            ...
                            <div class="mt-4">
                                <p class="text-muted"><span
                                        style="margin-right:.5rem;font-style:italic;font-weight:300;font-size:14px;"><?=$this->data->created_at?></span>
                                </p>
                            </div>
                            <div class="mt-4">
                                <div class="buttons are-transparent">
                                    <a href="/openrtb/report?start_date=<?=$this->data->last7days?>&end_date=<?=$this->data->today?>&ad_id=<?=$this->data->id?>"
                                        class="btn btn-info btn-light mb-1 btn-sm">
                                        <span class="icon">
                                            <svg viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                        ...
                                        <span>Impression:
                                            <?=$this->helper->numberFormat($this->data->impression)?></span>
                                    </a>
                                    <a href="/openrtb/report?start_date=<?=$this->data->last7days?>&end_date=<?=$this->data->today?>&ad_id=<?=$this->data->id?>"
                                        class="btn btn-info btn-light mb-1 btn-sm">
                                        <span class="icon">
                                    ...
                                    <button class="btn btn-danger btn-light mb-1 btn-sm">
                                        <span class="icon">
                                            <svg viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                        ...
                                        <span>eCPM
                                            <?php if($this->data->impression): ?><?=$this->helper->currencyFormat($this->data->revenue*1000/$this->data->impression)?><?php else: ?>$0.00<?php endif; ?></span>
                                    </button>
                                    <a href="/openrtb/rate?ad_id=<?=$this->data->id?>"
                                        class="btn is-danger btn-light mb-1 btn-sm">
                                        <span class="icon">
                                            <svg viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                        ...
                                        <span>CTR
                                            <?php if($this->data->impression): ?><?=round($this->data->click/$this->data->impression,4)*100?>%<?php else: ?>0.00%<?php endif; ?></span>
                                    </a>
                                    <a href="/openrtb/report?start_date=<?=$this->data->last7days?>&end_date=<?=$this->data->today?>&ad_id=<?=$this->data->id?>"
                                        class="btn btn-success btn-light mb-1 btn-sm">
                                        <span class="icon">
                                            <svg viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                    ...
                                    <a href="/openrtb/payment?ad_id=<?=$this->data->id?>"
                                        class="btn btn-primary btn-light mb-1 btn-sm">
                                        <span class="icon">
                                            <svg viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                        ...
                                        <span>Recorded:
                                            <?=$this->helper->currencyFormat($this->data->net_revenue)?></span>
                                    </a>
                                </div>
                            </div>
                            <hr>
                            <div class="buttons text-center mt-4">
                                ...
                                <?php endif; ?>
                                <a class="btn btn-primary btn-light mb-1"
                                    href="/openrtb/ad/setup?id=<?=$this->data->id?>">
                                    <span class="icon">
                                        <svg viewBox="0 0 24 24">
                                            <path fill="currentColor"
            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex align-items-end pb-0"
                        style="justify-content: end; padding-top: 1rem">
...
<div class="modal" id="sortModal" tabindex="-2" role="dialog" aria-labelledby="myModalLabel33"
    ...
    <div class="modal-card">
        <div class="modal-card-body">
            ...
            <div class="buttons is-centered pt-1">
                <button class="button is-light is-link btn-sort" data-sort="0" data-direction="desc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 7H22L18 3L14 7H17V21H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                        </svg>
                    </span>
                    <span>Country/Date</span>
                </button>
                <button class="button is-light is-info btn-sort" data-sort="1" data-direction="desc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 7H22L18 3L14 7H17V21H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                ...
                <button class="button is-light is-success btn-sort" data-sort="2" data-direction="desc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 7H22L18 3L14 7H17V21H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                ...
                <button class="button is-light is-primary btn-sort" data-sort="3" data-direction="desc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 7H22L18 3L14 7H17V21H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                ...
                <button class="button is-light is-warning btn-sort" data-sort="6" data-direction="desc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 7H22L18 3L14 7H17V21H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                ...
                <button class="button is-light is-danger btn-sort" data-sort="5" data-direction="desc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 7H22L18 3L14 7H17V21H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                ...
                <button class="button is-light is-link btn-sort" data-sort="0" data-direction="asc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 17H22L18 21L14 17H17V3H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                        </svg>
                    </span>
                    <span>Country/Date</span>
                </button>
                <button class="button is-light is-info btn-sort" data-sort="1" data-direction="asc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 17H22L18 21L14 17H17V3H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                ...
                <button class="button is-light is-success btn-sort" data-sort="2" data-direction="asc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 17H22L18 21L14 17H17V3H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                ...
                <button class="button is-light is-primary btn-sort" data-sort="3" data-direction="asc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 17H22L18 21L14 17H17V3H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                ...
                <button class="button is-light is-warning btn-sort" data-sort="6" data-direction="asc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 17H22L18 21L14 17H17V3H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
                ...
                <button class="button is-light is-danger btn-sort" data-sort="5" data-direction="asc">
                    <span class="icon">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19 17H22L18 21L14 17H17V3H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z"></path>
...
<div class="modal" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
     style="display: none;" aria-hidden="true">
...
<script>
    ...
    var type_table = 'Country',
        current_selected = 'impression',
        inited = false;

    function ucwords(str) {
        return (str + '').toLowerCase().replace(/^(.)|\s+(.)/g, function(l) {
    ...
    function drawChart() {
        ...
        if (!inited) {
            ...
            $(window).on('resize', function() {
                window.tadrawing = setTimeout(function() {
                    window.tachart.draw(data, window.taoptions)
                }, ms)
            });
        }
    ...
    function genTable() {
        ...
        for (const i in source_data) {
            ...
            html += '<td>$' + (source_data[i].revenue ? Math.round(source_data[i].revenue * 1000000 / source_data[i]
                .impression) / 1000 : '0.000') + '</td>';
            html += '<td>' + (source_data[i].click ? Math.round(source_data[i].click * 100000 / source_data[i].impression) /
                1000 : '0.000') + '%</td>';
            html += '<td>' + (source_data[i].conversion ? Math.round(source_data[i].conversion * 100000 / source_data[i]
                .impression) / 1000 : '0.000') + '%</td>';
            html += '</tr>';
        }
    ...
    google.charts.load('current', {
        ...
        'mapsApiKey': 'AIzaSyDRDJMzEc-lrhfpOgehmn8Duta9Y8Blius'
    });
