<div class="content-body">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            <h4 class="card-title">#<?=$this->data->id?> - <?=$this->data->name?></h4>
            ...
            <div class="page-title-box">
                <div class="row is-mobile">
                    <div class="col-12">
                        <h4 class="title is-6">Two-Factor</h4>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        <div class="row" id="2fablock">
                            <div class="col-12">
                                <div class="flatbox">
                                    <?php if($this->data->twoFactorToken): ?>
                                    <h3 class="title is-6">2FA - <?=$this->data->twoFactorToken?> method is enabled for your account</h3>
                                    <p class="subtitle is-6">It is recommended all the way. However, you can disable it if you really want</p>
                                    <div class="buttons is-centered">
                                        <button class="btn btn-danger" id="2fa-disable">
                                            <span class="icon">
                                    ...
                                    <?php else: ?>
                                    <h3 class="title is-6">2FA is disabled for your account.</h3>
                                    <p class="subtitle is-6">We highly recommend enabling it - so even somebody guesses your password, they won’t be able to access your account.
                                        Click the 2FA option you want to enable</p>
                                    <div class="buttons is-centered text-center">
                                        <button class="btn btn-primary 2fa-modal" data-type="app">
                                            <span class="icon">
                                                <svg viewBox="0 0 24 24">
                                        ...
                                        <button class="btn btn-success 2fa-modal" data-type="email">
                                            <span class="icon">
                                                <svg viewBox="0 0 24 24">
                                        ...
                                        <button class="btn btn-info 2fa-modal" data-type="sms">
                                            <span class="icon">
                                                <svg viewBox="0 0 24 24">
            ...
            <div class="page-title-box">
                <div class="row is-mobile">
                    <div class="col-12">
                        <h4 class="title is-6">RememberMe</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        <div class="row" id="cookieblock">
                            <div class="col-12">
                                <article class="flatbox">
                                    <h3 class="title is-6">Manage your RememberMe cookies</h3>
                                    <p class="subtitle is-6">Lost your personal devices that you are using RememberMe feature and your account is still logged in?
                                    ...
                                    <div class="buttons is-centered text-center">
                                        <button class="btn btn-warning" id="clear-all"<?php if(!$this->data->rememberMeToken): ?> disabled<?php endif; ?>>
                                        <span class="icon">
                                            <svg viewBox="0 0 24 24">
...
<div class="modal fade text-left" id="2fa-modal-app" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
         style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-card">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Authenticator App</h4>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary waves-effect waves-light 2fa-enable enterAction" data-type="app">Enable 2FA</button>
...
<div class="modal fade text-left" id="2fa-modal-app-submit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
     style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-card">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Email Authentication</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary waves-effect waves-light 2fa-enable-submit enterAction" data-type="app">Enable 2FA</button>
                    <button type="button" class="btn btn-secondary waves-effect waves-light btn-close" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
...
<div class="modal fade text-left" id="2fa-modal-email" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
     style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-card">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary waves-effect waves-light 2fa-enable enterAction" data-type="email">Enable 2FA</button>
                    <button type="button" class="btn btn-secondary waves-effect waves-light btn-close" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
...
<div class="modal fade text-left" id="2fa-modal-sms" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
     style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-card">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">SMS Authentication</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary waves-effect waves-light 2fa-enable enterAction" data-type="sms">Enable 2FA</button>
                    <button type="button" class="btn btn-secondary waves-effect waves-light btn-close" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
