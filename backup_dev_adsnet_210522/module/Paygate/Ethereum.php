...
class Ethereum
{
    ...
    protected $amount;
    protected $account;
    protected $payUrl = 'https://login.blockchain.com/en/#/home';
    ...
    public function depositDisplay()
    {
        ...
        $html .= 'Please make a payment from your BTC wallet as bellow: <br />';
        ...
        $html .= 'Do not have any BTC wallets yet? you can create one and buy BTC using your credit card';
        $html .= '<div class="buttons is-centered"><a class="button is-success" target="_blank" href="'.$this->payUrl.'">Go to Blockchain.com Wallet</a></div>';
        $html .= '</div></div>';
        $html .= '<div class="column"></div>';
        $html .= '</div>';
