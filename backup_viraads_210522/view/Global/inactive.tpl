...
<title>Inactive Account - <?=SITE_NAME?></title>
    ...
    <section class="hero is-fullheight is-bold">
        <div class="hero-body">
            <div class="container has-text-centered">
                <h1 class="title is-1 text-muted">Account Inactive</h1>
                <h2 class="subtitle is-6 text-muted">You did not activate your account</h2>
                <p>
