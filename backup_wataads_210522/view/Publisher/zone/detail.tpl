                ...
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        <p >
                            ...
                            If you want to use your own domain instead of ours to serve ads, apply it to <a class="has-text-success" href="/domain">Anti-Adblock Domains</a>
                        </p>
                ...
                <div class="card-content" style="min-height: 455px">
                    <div class="card-body card-dashboard">
                        <ul class="zone-detail" style="list-style: none; padding-left: 0">
                            ...
                            <li>Website: <a href="/website/detail/<?=$this->data->website_id?>"><?=$this->data->domain?></a>
                        ...
                        <div class="buttons text-center pt-5">
                            ...
                            <a class="btn waves-effect waves-light btn-danger mb-1" href="/zone/setup/<?=$this->data->id?>">
            ...
            <div class="modal-card">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="input is-medium form-control" type="text" id="name" placeholder="Zone Name" value="<?=$this->data->name?>">
                    </div>
                    <div class="form-group">
