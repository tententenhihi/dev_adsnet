<style>
    ...
    .flatbox.is-selected {
        border: 2px solid #006ed6 !important;
...
<script src="<?=$this->asset2('app-assets/vendors/js/ui/bootstrap-tagsinput.js')?>"></script>
<div class="content-body">
            ...
            <div class="card flatbox h-100">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        <div class="help-modal" data-toggle="modal" data-target="#helpModal1">
                            <span class="icon">
    ...
    <div class="row data-step" id="advanced-targeting">
        <div class="col-12">
        ...
        <div class="modal-content">
            <div class="modal-card">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-success waves-effect waves-light btn-close">Got It</button>
