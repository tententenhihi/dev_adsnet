                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-1">
                                ...
                                <tr>
                                    ...
                                    <td><a href="/report/schedule/<?=$item->id?>"><?=$item->
                                            name?></a></td>
                                    <td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-icon btn-icon rounded-circle btn-flat-danger waves-effect waves-light delete-report">
