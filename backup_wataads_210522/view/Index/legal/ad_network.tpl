    ...
    <section class="hero-7-bg position-relative bg-light d-flex align-items-center">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mx-auto text-center mb-4">
                    <h3 class="font-weight-normal text-dark">Ad Network <span class="text-warning">Policy</span></h3>
                    ...
                    <div id="content">
                        <div class="documentation__cnts">
                            <div class="documentation__cnt follow-block init in-sight anim-end">
                                <h3>Ad network integration</h3>
                                <p>We provide the most attractive conditions for partners with their own push subscribers base.
                                    The integration is based on JSON technology.
                                    Partnership models available: CPC (cost-per-click) & Revenue Share.
                                    Just fill out the form below and your personal manager will contact you ASAP.</p>
                                <section class="section">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <h3 class="text-warning mb-5">DSP / SSP Integration</h3>
                                            </div>
                                            <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group app-label">
                                                                ...
                                                                <input name="email" id="email" type="text" class="form-control" placeholder="Enter your name.." required />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group app-label">
                                                                <label for="phone">Number Phone</label>
                                                                <input name="phone" id="phone" type="text" class="form-control" placeholder="Enter your name.." required />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group app-label">
                                                                <label for="subscriber">Subscribles</label>
                                                                <select class="custom-select" id="subscriber">
                                                                    <option selected disabled>Number of subscribers</option>
    ...
    $(document).ready(function() {
        $('#submit').on('click', function() {
            ...
            var data = {
                ...
                subscriber : $.trim($('#subscriber').val()),
                message : $.trim($('#message').val())
            }
            if (data.name.length < 3 || data.email.indexOf('@') < 0 || data.phone.length < 3 || !data.subscriber.length || data.message.length < 10) {
                $("#show-mess").html('<p class="text-danger f-15 mb-4">Please fill contact form with valid informations!</p>');
                return false;
            }
            $this.prop('disabled', true);
            $this.html('Sending...');
            $.post('/legal/ad-network', {data: JSON.stringify(data)}, function(res) {
                if (!res.success) {
                    ...
                    $("#show-mess").html('<p class="text-success f-15 mb-4">We received your message, will get back shortly. Thank you</p>');
