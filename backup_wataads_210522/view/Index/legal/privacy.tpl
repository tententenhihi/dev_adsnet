    ...
    <section class="hero-7-bg position-relative bg-light d-flex align-items-center">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mx-auto text-center mb-4">
                    <h3 class="font-weight-normal text-dark">Privacy <span class="text-warning">Policy</span></h3>
                    ...
                    <div id="content" class="centring">
                        <div class="documentation__cnts">
                            <div class="documentation__cnt follow-block init in-sight anim-end">
                                ...
                                <p>When we disclose your information to the third party, we require those third parties to have appropriate technical and organizational measures in place to protect your personal data. We will not share any of your personal data for any purpose other than the purposes described in this Privacy Policy, nor will we sell your personal data to anyone.</p>
                                ...
                                <ol>
                                    <li>The right to be informed. Users have a right to be aware of our personal data protection clauses and data processing activities, whose details are contained in this Privacy Policy.</li>
                                    <li>The right to access. You have a right to request for information about the personal data we hold about you by creating a support ticket. Please state a compelling reason for the request.</li>
                                    <li>The right of data correction. You have an option to update your personal data using your profile section. In order to change any additional information please inform us and we will update our data records as soon as possible.</li>
                                    <li>The right to erasure. If you no longer wish us to hold your personal data, please notify us using the support ticket system and we will remove it from our database within a month. Please note that it is not possible to provide our services without holding your personal data.</li>
                                    <li>The right to restrict processing. You have a right to object that we are no longer process your personal data in certain ways, whilst not requiring us to delete the same data.</li>
                                    <li>The right to transfer portability. You have a right to receive personal data copy we hold about you. As well, you may request that we transfer your personal data directly to the third party if it’s technically possible.</li>
                                    <li>The right to object. If you feel your fundamental rights and freedoms are being impacted you have a right to object us using your personal data, unless we have overriding legitimate grounds for such processing. As well, you have a right to object if we use your personal data for marketing purposes (including profiling) or for statistical and research purposes. Please notify us of your objection and we will cease such data processing.</li>
