                        ...
                        <div class="hero mt-2">
                            <div class="hero-body">
                                <div class="text-center">
                                    <p class="title is-6">You don't have any exchange payments yet</p>
        ...
        <div class="modal-content">
            <div class="modal-card">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary waves-effect waves-light" id="save">Submit</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#save').on('click', function () {
            ...
            $.post('/exchange/payment', {csrf_token: __tajs.csrf, data: JSON.stringify(data)}, function (res) {
